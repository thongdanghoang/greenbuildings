...
export class ToolboxComponent extends SubscriptionAwareComponent {
  @ViewChild('actionsTemplate', {static: true})
  actionsTemplate!: TemplateRef<any>;
  cols: TableTemplateColumn[] = [];
  productCriteria!: ProductCriteria;
  protected fetchProducts!: (criteria: SearchCriteriaDto<ProductCriteria>) => Observable<SearchResultDto<Product>>;
  ...
  testToast(): void {
    ...
    this.messageService.success({
      ...
      closable: false,
      key: 'center',
      styleClass: 'p-6 min-w-[400px] max-w-[600px] bg-white dark:bg-gray-800 shadow-lg rounded-lg'
    });
  }
}
