...
export class SidebarComponent extends SubscriptionAwareComponent implements OnInit {
  ...
  private buildEnterpriseOwnerMenu(): MenuItem[] {
    return [
      ...
      },
      {
        ...
        items: [
          {
            label: 'sidebar.owner.tenant',
            icon: 'pi pi-users',
            route: `/${AppRoutingConstants.ENTERPRISE_PATH}/${AppRoutingConstants.LINKED_TENANT_PATH}`
          },
          // {
  ...
  private buildAdminMenu(): MenuItem[] {
    return [
      ...
      {
        label: 'sidebar.admin.tradingActivities',
        items: [
          {
            label: 'sidebar.admin.revenue',
            icon: 'pi pi-chart-pie',
            route: `/${AppRoutingConstants.ADMIN_PATH}/${AppRoutingConstants.REVENUE_OVERVIEW}`
          },
          {
            label: 'sidebar.admin.payment',
            icon: 'pi pi-wallet',
            route: `/${AppRoutingConstants.ADMIN_PATH}/${AppRoutingConstants.PAYMENT_ENTERPRISE_MANAGEMENT}`
          },
          {
            label: 'sidebar.admin.transaction',
            icon: 'pi pi-dollar',
            route: `/${AppRoutingConstants.ADMIN_PATH}/${AppRoutingConstants.TRANSACTION_ENTERPRISE_MANAGEMENT}`
          }
        ]
      }
    ];
